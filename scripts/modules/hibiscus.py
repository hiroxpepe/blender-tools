## Blender Python Script for Hibiscus
###### created: 2022-05-20
###### updated: 2022-06-25
...
def set_motion(frame_end: int) -> None:
    ...
    for ob in object_list:
        ob: Object
        if "Hibiscus" in ob.name:
            armature.rename_bones(object_name=ob.name, prefix="hbcs")
            bone_name: str = "hbcs_Bone1"
